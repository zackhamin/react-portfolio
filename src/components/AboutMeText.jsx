...
export default function AboutMeText() {
  return (
    ...
    >
      <p>
        I am a dedicated and ambitious junior developer, eager to learn and
        already making an impact! <br />
        <br />
        After teaching myself how to code, almost a year and a half ago, I have
        gone from strength to strength in the industry, building a network of
        aspiring career changers, junior and senior developers as well as
        ...
        family are big fans of hiking, we have a few camping trips booked for
        2021, Spending time with my kids helps me appreciate how far I have come
        in this industry in a relatively short time.
        <br />
        <br />
        Dad,husband, community organiser and more.
      </p>
    </div>
  );
}
